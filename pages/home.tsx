      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.leftSection}>
          ...
          <p>
            ...
            información clave de una sola imagen o procesar múltiples archivos,
            extractData te facilita esta tarea.
          </p>
          <h2>Extracción personalizada</h2>
          <p>
            Selecciona áreas específicas en una imagen para extraer texto o
            imágenes. Define exactamente qué partes del documento son relevantes
            y obtén resultados precisos en formato <strong>TXT</strong> o como
            recortes de imagen.
          </p>
          ...
          <p>
            ...
            resultados pueden obtenerse como texto en archivos separados o como
          ...
          <ul>
            ...
            <li>
              <strong>Automatización</strong>: Carga archivos ZIP y permite que
              el sistema haga el trabajo por ti, extrayendo automáticamente el
              contenido deseado.
            </li>
          </ul>
        </div>
        ...
        <div className={styles.rightSection}>
          ...
          <div className={styles.step}>
            ...
            <p>
              ...
              el archivo ZIP que contiene las imágenes a procesar. Asegúrate de
              que todas las imágenes sean similares a la plantilla seleccionada.
            </p>
          </div>
          <div className={styles.step}>
          ...
          <div className={styles.step}>
            ...
            <p>
              ...
              el archivo ZIP, extrayendo texto o imágenes de cada archivo según
              la configuración. Recibirás los resultados en formato TXT o en
              imágenes recortadas.
            </p>
          </div>
        </div>
